...
namespace OnlineShopProject.Controllers
{
    ...
    */
    public class ProductsController : ODataController
    {
        ...
        // GET: odata/Products(5)/ProductCategories
        [EnableQuery]
        public SingleResult<ProductCategory> GetProductCategories([FromODataUri] int key)
        {
            return SingleResult.Create(db.Products.Where(m => m.ProductID == key).Select(m => m.ProductCategories));
        }

        // GET: odata/Products(5)/Supplaiers
        [EnableQuery]
        public SingleResult<Supplaier> GetSupplaiers([FromODataUri] int key)
        {
            return SingleResult.Create(db.Products.Where(m => m.ProductID == key).Select(m => m.Supplaiers));
        }
